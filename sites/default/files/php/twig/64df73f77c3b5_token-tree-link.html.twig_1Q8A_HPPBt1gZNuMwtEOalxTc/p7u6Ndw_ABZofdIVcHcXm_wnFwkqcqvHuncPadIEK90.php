...
class __TwigTemplate_56fe14a4665b9bc22efcb8d4d2a004f2 extends Template
{
    private $source;
    private $macros = [];
...
{% if link -%}
  {{ link }}
{%- endif %}
", "modules/contrib/token/templates/token-tree-link.html.twig", "/opt/drupal/web/modules/contrib/token/templates/token-tree-link.html.twig");
    }

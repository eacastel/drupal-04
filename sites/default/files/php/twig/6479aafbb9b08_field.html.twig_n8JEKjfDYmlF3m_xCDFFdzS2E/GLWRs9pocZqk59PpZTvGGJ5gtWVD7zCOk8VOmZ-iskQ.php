...
/* themes/custom/endossmp_theme/templates/field/field.html.twig */
class __TwigTemplate_e41e88138a0174ec12ceb11220cc4788 extends Template
{
    private $source;
    private $macros = [];
...
($context["label_display"] ?? null) == "visually_hidden")) ? ("sr-only") : (""))];
      ...
      ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 59
                    echo "        ";
                    if (((((($context["field_name"] ?? null) == "field_feature_title") || (($context["field_name"] ?? null) == "field_about_us_title")) || (($context["field_name"] ?? null) == "field_join_us_title")) || (($context["field_name"] ?? null) == "field_testimonial_title"))) {
                        // line 60
                        echo "          <h2";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    ...
                    if (((((($context["field_name"] ?? null) == "field_feature_title") || (($context["field_name"] ?? null) == "field_about_us_title")) || (($context["field_name"] ?? null) == "field_join_us_title")) || (($context["field_name"] ?? null) == "field_testimonial_title"))) {
                        // line 69
                        echo "        <h2";
                        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 69), "addClass", [0 => ($context["classes"] ?? null), 1 => "field--item"], "method", false, false, true, 69), 69, $this->source), "html", null, true);
                        echo ">";
      ...
      ";
                        ...
                        // line 71
                        echo "        <div";
                        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 71), "addClass", [0 => ($context["classes"] ?? null), 1 => "field--item"], "method", false, false, true, 71), 71, $this->source), "html", null, true);
                        echo ">";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 82
                echo "      <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 82), "addClass", [0 => "field--item"], "method", false, false, true, 82), 82, $this->source), "html", null, true);
                echo ">";
...
";
    ...
    {
        return "themes/custom/endossmp_theme/templates/field/field.html.twig";
    }
    ...
    {
        return array (  164 => 87,  160 => 85,  157 => 84,  146 => 82,  141 => 81,  137 => 79,  135 => 78,  129 => 77,  124 => 76,  120 => 74,  114 => 73,  106 => 71,  98 => 69,  95 => 68,  90 => 67,  86 => 65,  80 => 64,  72 => 62,  64 => 60,  61 => 59,  57 => 58,  52 => 57,  49 => 56,  47 => 55,  45 => 52,  44 => 50,  42 => 46,  41 => 45,  40 => 44,  39 => 42,);
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes.addClass(classes, 'field--items') }}>
      {% for item in items %}
        {% if field_name == 'field_feature_title' or field_name == 'field_about_us_title' or field_name == 'field_join_us_title' or field_name == 'field_testimonial_title' %}
  ...
  {% else %}
    {% for item in items %}
      {% if field_name == 'field_feature_title' or field_name == 'field_about_us_title' or field_name == 'field_join_us_title' or field_name == 'field_testimonial_title' %}
        <h2{{ item.attributes.addClass(classes, 'field--item') }}>{{ item.content }}</h2>
      {% else %}
...
{% endif %}
", "themes/custom/endossmp_theme/templates/field/field.html.twig", "/opt/drupal/web/themes/custom/endossmp_theme/templates/field/field.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 42, "if" => 55, "for" => 58);

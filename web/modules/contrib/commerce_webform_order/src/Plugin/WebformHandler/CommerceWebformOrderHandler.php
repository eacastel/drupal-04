...
class CommerceWebformOrderHandler extends WebformHandlerBase {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    ...
    $form['tabs_wrapper']['checkout']['new_order'] = [
      '#type' => 'checkbox',
      '#title' => $this->t('Force a new order to be created with each submission'),
      '#description' => $this->t('If checked, current users cart will dismissed and a new one will be created.'),
      '#suffix' => '<hr />',
      '#return_value' => TRUE,
      '#parents' => ['settings', 'checkout', 'new_order'],
      '#default_value' => $this->configuration['checkout']['new_order'],
    ];
